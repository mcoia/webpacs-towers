...
function addMainContentMenu()
{
	...
	if (linkLocation)
		...
		+ '<div>&nbsp;&nbsp;<img src="/screens/greenpaw.gif" alt=""/>&nbsp;<a href="/search~S4/q">Author and Title Search</a></div>'
		+ '<div>&nbsp;&nbsp;<img src="/screens/greenpaw.gif" alt=""/>&nbsp;<a href="/search~S4/m">Subject (Children\'s)</a></div>'
		...
		+ '<div>&nbsp;&nbsp;<img src="/screens/greenpaw.gif" alt=""/>&nbsp;<a href="/search~S4/i">ISBN,ISSN,Music</a></div>'
...
function mainNavLinks(nosearchtips)
{
	...
	if (linkLocation)
		...
		+ '<div><img src="/screens/greenpaw.gif" alt=""/>&nbsp;<a href="/patroninfo~S4">Your Account (renew, holds, etc.)</a></div>'
